...
void bubnim(Mahasiswa *mhs, int n){
    string tmp;
    for (int i = 0; i < n; i++)
    {
        for (int j = i+1; j < n; j++)
...
void bubipk(Mahasiswa *mhs, int n){
    int tmp;
    for (int i = 0; i < n; i++)
    {
        for (int j = i+1; j < n; j++)
...
void fitur(Mahasiswa *mhs, int n){
    ...
    do
    {
        ...
        cout << "3. Pengurutan berdasarkan NIM\n";
        cout << "4. Pengurutan berdasarkan IPK\n";
        cout << "Pilihan: ";
        cin >> pick;
        cout << endl;
        if (pick == '1')
